...
#
# Generated by export_simulation on Sat May 22 20:14:14 +0200 2021
#
################################################################################
...
switch to the './MAXONAR.sh' script.

./MAXONAR.sh -reset_run
...
./MAXONAR.sh -noclean_files

For more information on the script, please type './MAXONAR.sh -help'.
