...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L processing_system7_bfm_v2_0_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MAXONAR xil_defaultlib.MAXONAR xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim MAXONAR -key {Behavioral:sim_1:Functional:MAXONAR} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MAXONAR.wdb xsim.dir)
