...
HD_PWD='E:/zybo/PMOD_MAXSONAR/PMOD_MAXSONAR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MAXONAR_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MAXONAR_wrapper.tcl
