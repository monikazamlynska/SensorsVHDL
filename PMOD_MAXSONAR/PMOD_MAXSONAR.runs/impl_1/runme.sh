...
HD_PWD='E:/zybo/PMOD_MAXSONAR/PMOD_MAXSONAR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MAXONAR_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MAXONAR_wrapper.tcl -notrace
